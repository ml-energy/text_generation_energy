...
This is a fork of `text_generation` that adds per-token energy consumption information.
This library is used by the [ML.ENERGY leaderboard](https://github.com/ml-energy/leaderboard) Colosseum.

Content below is as-is from the original text_generation client README.
